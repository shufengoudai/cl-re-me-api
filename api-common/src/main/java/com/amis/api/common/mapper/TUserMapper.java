...
public interface TUserMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0329758+08:00", comments="Source Table: t_user")
    BasicColumn[] selectList = BasicColumn.columnList(id, userName, userFullname, password, authority, position, userMail, userTel, userDepart, userSex, userNotify, insAccountId, insDtTime, updAccountId, updDtTime, logicalDelDiv);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0219689+08:00", comments="Source Table: t_user")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    long count(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0229697+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0239699+08:00", comments="Source Table: t_user")
    @InsertProvider(type=SqlProviderAdapter.class, method="insertMultiple")
    int insertMultiple(MultiRowInsertStatementProvider<TUser> multipleInsertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0249704+08:00", comments="Source Table: t_user")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0269717+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0279722+08:00", comments="Source Table: t_user")
    ...
    default int insert(TUser record) {
        return MyBatis3Utils.insert(this::insert, record, TUser, c ->
            c.map(id).toProperty("id")
            .map(userName).toProperty("userName")
            .map(userFullname).toProperty("userFullname")
            .map(password).toProperty("password")
            .map(authority).toProperty("authority")
            .map(position).toProperty("position")
            .map(userMail).toProperty("userMail")
            .map(userTel).toProperty("userTel")
            .map(userDepart).toProperty("userDepart")
            .map(userSex).toProperty("userSex")
            .map(userNotify).toProperty("userNotify")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0299736+08:00", comments="Source Table: t_user")
    ...
    default int insertSelective(TUser record) {
        return MyBatis3Utils.insert(this::insert, record, TUser, c ->
            ...
            .map(userFullname).toPropertyWhenPresent("userFullname", record::getUserFullname)
            ...
            .map(userMail).toPropertyWhenPresent("userMail", record::getUserMail)
            .map(userTel).toPropertyWhenPresent("userTel", record::getUserTel)
            .map(userDepart).toPropertyWhenPresent("userDepart", record::getUserDepart)
            .map(userSex).toPropertyWhenPresent("userSex", record::getUserSex)
            .map(userNotify).toPropertyWhenPresent("userNotify", record::getUserNotify)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0339769+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0349778+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0359779+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0369784+08:00", comments="Source Table: t_user")
    static UpdateDSL<UpdateModel> updateAllColumns(TUser record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalTo(record::getId)
                .set(userName).equalTo(record::getUserName)
                .set(userFullname).equalTo(record::getUserFullname)
                .set(password).equalTo(record::getPassword)
                .set(authority).equalTo(record::getAuthority)
                .set(position).equalTo(record::getPosition)
                .set(userMail).equalTo(record::getUserMail)
                .set(userTel).equalTo(record::getUserTel)
                .set(userDepart).equalTo(record::getUserDepart)
                .set(userSex).equalTo(record::getUserSex)
                .set(userNotify).equalTo(record::getUserNotify)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(TUser record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(id).equalToWhenPresent(record::getId)
                ...
                .set(userFullname).equalToWhenPresent(record::getUserFullname)
                .set(password).equalToWhenPresent(record::getPassword)
                .set(authority).equalToWhenPresent(record::getAuthority)
                .set(position).equalToWhenPresent(record::getPosition)
                .set(userMail).equalToWhenPresent(record::getUserMail)
                .set(userTel).equalToWhenPresent(record::getUserTel)
                .set(userDepart).equalToWhenPresent(record::getUserDepart)
                .set(userSex).equalToWhenPresent(record::getUserSex)
                .set(userNotify).equalToWhenPresent(record::getUserNotify)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0379786+08:00", comments="Source Table: t_user")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-09-08T14:03:08.0389804+08:00", comments="Source Table: t_user")
